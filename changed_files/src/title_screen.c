...
static bool8 sQuickstartAutoTriggered = FALSE;
...
void CB2_InitTitleScreen(void)
{
    ...
    default:
    case 0:
        sQuickstartAutoTriggered = FALSE;
...
{
    if (QUICKSTART && QUICKSTART_AUTO && !sQuickstartAutoTriggered)
    {
        sQuickstartAutoTriggered = TRUE;
        Quickstart();
    }
