...
void CB2_NewGame(void)
{
    ...
    // Kanto Saison 1 : plus de cinématique du camion (le joueur habite déjà Bourg Palette,
    // cf. new_game.c/WarpToPlayerBedroom), donc plus besoin de ExecuteTruckSequence ici —
    // ce champ de rappel tournait quand même sur chaque nouvelle partie, indépendamment de la
    // carte d'arrivée réelle, et provoquait les tremblements de caméra fantômes signalés en test.
