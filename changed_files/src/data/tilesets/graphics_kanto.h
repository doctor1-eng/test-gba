...
const u32 gTilesetTiles_PewterCityKanto[] = INCGFX_U32("data/tilesets/secondary/pewter_city_frlg/tiles.png", ".4bpp.fastSmol");

const u16 ALIGNED(4) gTilesetPalettes_PewterCityKanto[][16] =
{
