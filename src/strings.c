...
const u8 gText_ExpandedPlaceholder_ChampionM[] = _("Champion");
const u8 gText_ExpandedPlaceholder_ChampionF[] = _("Championne");
const u8 gText_ExpandedPlaceholder_ChampionIndefM[] = _("un Champion");
const u8 gText_ExpandedPlaceholder_ChampionIndefF[] = _("une Championne");
const u8 gText_ExpandedPlaceholder_ChampionIndefCapM[] = _("Un Champion");
const u8 gText_ExpandedPlaceholder_ChampionIndefCapF[] = _("Une Championne");
const u8 gText_ExpandedPlaceholder_ChampionDefM[] = _("le Champion");
const u8 gText_ExpandedPlaceholder_ChampionDefF[] = _("la Championne");
const u8 gText_ExpandedPlaceholder_ChampionPossM[] = _("son Champion");
const u8 gText_ExpandedPlaceholder_ChampionPossF[] = _("sa Championne");
const u8 gText_ExpandedPlaceholder_EAccordM[] = _("");
const u8 gText_ExpandedPlaceholder_EAccordF[] = _("e");
