...
#define FLAG_COMMERCANT_VIRIDIAN_RESOLU             (HNS_EXTENDED_CONTENT_START + 329)
#define FLAG_BUCHERONS_RESOLU                       (HNS_EXTENDED_CONTENT_START + 330)
#define FLAG_CANALISATIONS_REPAREES                 (HNS_EXTENDED_CONTENT_START + 331)
#define FLAG_MAJORBOB_CONVAINCU                     (HNS_EXTENDED_CONTENT_START + 332)
...
#define HNS_EXTENDED_CONTENT_COUNT                  335
