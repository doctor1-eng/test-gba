...
|---|---|---|---|---|
| Cinnabar (île) | `CinnabarIsland_hns` | `Route20_hns`, `Route21_hns` (→ Johto), warp Pokémon Center | Oui, mais **incomplète** | Pas de warp vers Gym/Mansion/Lab — à ajouter (voir "Bâtiments manquants"). PNJ Blaine/Blue existants à réécrire (voir conflit narratif). |
